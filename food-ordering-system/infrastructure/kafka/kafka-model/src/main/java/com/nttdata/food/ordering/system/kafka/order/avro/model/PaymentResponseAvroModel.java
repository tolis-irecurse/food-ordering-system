...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1074887913747773986L;
  ...
  private com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentStatus = (com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus)value$; break;
   ...
   */
  public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus value) {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentStatus) defaultValue(fields()[7]);
