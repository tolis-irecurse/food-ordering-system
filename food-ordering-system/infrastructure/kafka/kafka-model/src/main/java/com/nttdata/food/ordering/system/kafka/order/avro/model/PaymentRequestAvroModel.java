...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7035476307191509549L;
  ...
  private com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPaymentOrderStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus value) {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (com.nttdata.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
