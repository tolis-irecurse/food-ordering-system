...
public class PaymentMessagingDataMapper {
    ...
    paymentCompletedEventToPaymentResponseAvroModel(PaymentCompletedEvent paymentCompletedEvent) {
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setPaymentStatus(PaymentStatusAvroModel.valueOf(paymentCompletedEvent.getPayment().getPaymentStatus().name()))
    ...
    paymentCancelledEventToPaymentResponseAvroModel(PaymentCancelledEvent paymentCancelledEvent) {
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setPaymentStatus(PaymentStatusAvroModel.valueOf(paymentCancelledEvent.getPayment().getPaymentStatus().name()))
    ...
    paymentFailedEventToPaymentResponseAvroModel(PaymentFailedEvent paymentFailedEvent) {
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setPaymentStatus(PaymentStatusAvroModel.valueOf(paymentFailedEvent.getPayment().getPaymentStatus().name()))
