...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6025785173926350895L;
  ...
  private com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus;
  private java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product> products;
   ...
   */
  public RestaurantApprovalRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID restaurantId, java.util.UUID orderId, com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus, java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product> products, java.math.BigDecimal price, java.time.Instant createdAt) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: restaurantOrderStatus = (com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus)value$; break;
    case 5: products = (java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product>)value$; break;
   ...
   */
  public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus getRestaurantOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setRestaurantOrderStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus value) {
   ...
   */
  public java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product> getProducts() {
    return products;
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product> value) {
    this.products = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantOrderStatus(com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setProducts(java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product> value) {
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus : (com.nttdata.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus) defaultValue(fields()[4]);
        record.products = fieldSetFlags()[5] ? this.products : (java.util.List<com.nttdata.food.ordering.system.kafka.order.avro.model.Product>) defaultValue(fields()[5]);
