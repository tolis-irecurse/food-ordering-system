package com.nttdata.food.ordering.system.kafka.consumer.config;

import com.nttdata.food.ordering.system.kafka.config.data.KafkaConfigData;
import com.nttdata.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaConfigData.getBootrstrapServers());
